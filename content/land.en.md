...
<p class="lede">Where the datacentres are being built and on what kind of soil. Disclosed footprints, the PIGA fast-track and compulsory purchase, the environmental shortcut, and how to check a parcel yourself. All figures cited; the chart is built from the same dataset that powers the map.</p>
